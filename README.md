# Документация на проект за ходограф и крива на Безие

## Папка "Documentation" съдържа pdf файл със същата документация която е изписана по-долу
## Папка "Project HTML File" съдържа файлът за проекта
...
- **hodographBezierCurve.html** -- основният файл на проекта
